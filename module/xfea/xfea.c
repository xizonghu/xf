...
static int8_t indexOf(XF_Event *evt, XF_Action *act) {
    uint8_t i = 0;
...
void XF_EventCreate(XF_Event *evt, XF_EventType type, XF_event_query_callback query, XF_Info infos[], XF_Memory dataInfos[], uint8_t sizeInfos, XF_Action *actions[], uint8_t sizeActions) {
    uint8_t i = 0;
...
int8_t XF_EventAddAct(XF_Event *evt, XF_Action *act) {
    uint8_t i = 0;
...
int8_t XF_EventRemoveAct(XF_Event *evt, XF_Action *act) {
    int8_t i = 0;
...
uint8_t XF_EventExecuteAct(XF_Event *evt) {
    uint8_t cnt = 0;
    uint8_t i = 0, j = 0;
...
uint8_t XF_EventPackageDispatch(XF_EventPackage evtPkg) {
    uint8_t cnt = 0;
